      ...
      <div className="relative min-h-[calc(100vh-var(--navbar-height))] mt-[var(--navbar-height)] bg-[#F8F7F4] pb-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <h1 className="text-[35px] sm:text-[45px] md:text-[55px] lg:text-[65px] font-ogg font-semibold text-gray-600 leading-[0.9] tracking-wider uppercase px-8 [-webkit-font-smoothing:antialiased] [text-rendering:optimizeLegibility]">
              Les événements
            </h1>
            <div className="flex-1 h-0.5 bg-gray-300"></div>
          </motion.div>
