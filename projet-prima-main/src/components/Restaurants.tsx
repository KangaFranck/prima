                        ...
                        <div className="aspect-square flex items-center justify-center bg-gray-50 rounded-md overflow-hidden">
                          {restaurant.logo ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center bg-gray-100">
                              <span className="text-4xl font-playfair">{restaurant.nom.charAt(0)}</span>
                            </div>
                          )}
                        </div>
                        <h3 className="mt-2 text-base font-playfair text-center truncate px-1">{restaurant.nom}</h3>
                      </motion.div>
                    </Link>
                  ))}
                </motion.div>
