              ...
              <div className="grid grid-cols-3 gap-4 md:gap-8 max-w-4xl mx-auto px-4">
                {[
                  ...
                  <div key={index} className="flex flex-col items-center opacity-100 md:opacity-0 md:hover:opacity-100 transition-opacity duration-300">
                    ...
                    <p className="text-white text-xs md:text-sm font-neue font-light">{video.title}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            {universeBlocks.map((block, index) => (
              <div key={index} className={`flex flex-col lg:flex-row items-center gap-12 ${
                ...
                <div className="w-full lg:w-1/2 text-center lg:text-left">
                  <h2 className="text-4xl lg:text-5xl font-playfair mb-4 text-gray-800">
                    {block.title}
                  </h2>
      ...
      <section className="py-12 relative overflow-hidden bg-[#E5DDD3]">
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-8">
            <h2 className="text-4xl font-playfair mb-4 text-gray-800">DES COMMERCES OUVERTS 7J/7</h2>
          </div>
