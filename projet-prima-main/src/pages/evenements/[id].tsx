        ...
        <div className="absolute inset-0 flex items-end">
          <div className="w-full p-8 lg:p-16">
            <div className="max-w-4xl mx-auto">
              ...
              {/* Titre principal */}
              <h1 className="text-5xl lg:text-7xl font-['Playfair_Display'] text-white mb-6 leading-tight">
                {evenement.title}
              </h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white p-8 lg:p-12">
              <h2 className="text-3xl font-['Playfair_Display'] text-black mb-6">À propos de cet événement</h2>
      ...
      <div className="bg-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-['Playfair_Display'] text-black mb-4">Découvrez d'autres événements</h2>
