...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#F5F5DC] py-12 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div>
          <h2 className="mt-6 text-center text-3xl font-['Playfair_Display'] text-[#2C2C2C]">
            Connexion
          </h2>
          <p className="mt-2 text-center text-sm font-neue text-gray-600">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 font-neue rounded-md focus:outline-none focus:ring-[#2C2C2C] focus:border-[#2C2C2C] focus:z-10 sm:text-sm"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="appearance-none relative block w-full px-3 py-2 pr-10 border border-gray-300 placeholder-gray-500 text-gray-900 font-neue rounded-md focus:outline-none focus:ring-[#2C2C2C] focus:border-[#2C2C2C] focus:z-10 sm:text-sm"
