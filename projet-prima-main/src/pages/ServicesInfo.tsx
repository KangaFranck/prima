        ...
        <div className="absolute inset-0 bg-black/30 backdrop-filter">
          <div className="relative z-10 text-center max-w-4xl mx-auto px-4 py-20">
            <motion.h1
              ...
              className="text-[45px] sm:text-[60px] md:text-[75px] lg:text-[90px] font-neue font-extralight text-white leading-[0.9] tracking-wider uppercase mb-4 [-webkit-font-smoothing:antialiased] [text-rendering:optimizeLegibility]"
            >
            ...
            <motion.p
              ...
              className="text-[16px] sm:text-[20px] md:text-[24px] lg:text-[28px] font-neue font-extralight text-white [-webkit-font-smoothing:antialiased]"
            >
